...
%	Satow, T., Aso, T., Nishida, S., Komuro, T., Ueno, T., Oishi, N., Åc Fukuyama, H. (2017). Alteration of venous drainage route in idiopathic normal pressure hydrocephalus and normal aging. Frontiers in Aging Neuroscience, 9(NOV), 1-10. https://doi.org/10.3389/fnagi.2017.00387
%	Nishida, S., Aso, T., Takaya, S., Takahashi, Y., Kikuchi, T., Funaki, T., Åc Miyamoto, S. (2018). Resting-state Functional Magnetic Resonance Imaging Identifies Cerebrovascular Reactivity Impairment in Patients With Arterial Occlusive Diseases: A Pilot Study. Neurosurgery, 0(0), 1-9. https://doi.org/10.1093/neuros/nyy434
...
%if ~exist( ['masked_' num2str( MaxLag) 's.nii'])
...
% discard = ceil( 10/TR);  % removing initial transient just in case
% Y = Y(:,:,:,discard:end);
